...
const URLEND =
  "&addRecipeNutrition=true&fillIngredients=true&instructionsRequired=true&addRecipeInformation=true&number=9";

function SpoonacularAPI(query) {
  return axios.get(BASEURL + query + APIKEY + URLEND).then((response) => {
